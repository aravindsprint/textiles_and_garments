...
frappe.ui.form.on("Loading and Unloading Payments", {
    ...
    after_save: function(frm) {
        if(frm.doc.grand_total_for_stock_entry >=0 || frm.doc.grand_total_for_purchase_receipt >=0){
         frm.doc.grand_total = frm.doc.grand_total_for_stock_entry + frm.doc.grand_total_for_purchase_receipt;
         frm.doc.net_total = frm.doc.net_total_for_stock_entry + frm.doc.net_total_for_purchase_receipt;
