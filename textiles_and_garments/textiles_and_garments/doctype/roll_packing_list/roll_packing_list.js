...
// Client Script: Roll Packing List - Create Manufacture Entry Button
// DocType: Roll Packing List
// Type: Form
...
function create_manufacture_entry(frm) {
    frappe.confirm(
        ...
        function() {
            // User confirmed
            // frappe.call({
            //     method: 'frappe_assistant_core.frappe_assistant_core.doctype.roll_packing_list.roll_packing_list.create_manufacture_entry_from_roll_packing',
            //     args: {
            //         doc: frm.doc
            //     },
            //     freeze: true,
