...
frappe.ui.form.on("Purchase Loss", {
    refresh(frm) {

    },
    calculate_process_loss: function (frm) {
        frappe.call({
            method: 'textiles_and_garments.textiles_and_garments.doctype.purchase_loss.purchase_loss.calculate_process_loss',
            args: {
    ...
    calculate_summary: function (frm) {
        frappe.call({
            method: 'textiles_and_garments.textiles_and_garments.doctype.purchase_loss.purchase_loss.calculate_summary',
            args: {
                docname: frm.doc.name,
                // purchase_orders: frm.doc.purchase_orders
            },
