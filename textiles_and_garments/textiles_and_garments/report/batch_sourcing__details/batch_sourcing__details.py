...
# This code will fetch item_code, batch_no, doctype, docname, qi, attachment
...
#         # If there are attachments, create a row for each attachment
...
#             attachments = get_attachments(qi_doc) if qi_doc else []
#             batch_data = {
#                 "batch": batch,
...
# def get_attachments(qi_doc):
#     """Get all attachments from a Quality Inspection document"""
#     if not qi_doc:
#         return []
    
#     attachments = frappe.get_all("File", 
#         filters={
#             "attached_to_name": qi_doc.name,
...
#     """Generate HTML link for an attachment with direct file URL"""
#     if not attachment:
#         return None
...
#         file_url = file_url[1:]  # Remove one leading slash (keeps one)
#     elif file_url.startswith("files/"):
#         pass  # Already correct format
#     else:
#         file_url = f"files/{file_url}"  # Add files/ prefix if missing
    
#     # Construct the full URL with your localhost domain
#     full_url = f"http://localhost:8000/{file_url}"
    
#     # Use a safer approach that works with modern browser security policies
#     return f"""
#     <a href="{full_url}" 
#        target="_blank"
#        title="{file_name}">
