...
// 						title: __('Attendance Report as on ' + filters.from_date + ' (Staff)'),
// 						fields: [
// 							{
// 								fieldtype: 'HTML',
...
// 							let export_data = summary_array.map(row => ({
// 								'Department': row.department,
// 								'Onroll Strength': row.onroll,
// 								'Present': row.present,
// 								'Leave & Absent': row.absent
// 							}));
							
// 							// Add grand total row
// 							export_data.push({
// 								'Department': 'Grand Total',
// 								'Onroll Strength': total_onroll,
// 								'Present': total_present,
// 								'Leave & Absent': total_absent
// 							});
