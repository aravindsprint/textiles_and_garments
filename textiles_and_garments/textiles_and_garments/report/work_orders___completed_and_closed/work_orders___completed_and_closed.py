...
def get_columns():
    ...
    return [
        ...
        {
            "label": _("Pending Qty to Manufacture"),
...
def get_data(filters):
    """Get Work Orders in Submitted state that are Completed or Closed with production_item like GKF%"""
    ...
    query = """
        ...
        {conditions}
        ORDER BY wo.actual_end_date DESC, wo.planned_end_date DESC
